...
| --- | --- | --- | --- | --- |
| 410.1 | Create `textures.ts` and export fallbacks | Not Started | 2025-10-27 | Keep identity of fallback textures stable |
| 410.2 | Extract `deriveHazeUniform`/`deriveBoundaryUniform` to `uniforms.ts` and write unit tests | Not Started | 2025-10-27 | Add tests for edge cases |
| 410.3 | Move material creation & update logic to `materialFactory.ts` | Not Started | 2025-10-27 | Import textures + uniforms |
| 410.4 | Extract dev helpers into `devHelpers.ts` and guard them | Not Started | 2025-10-27 | export `installDevHelpers` and `dispose` |
| 410.5 | Re-export public API for compatibility | Not Started | 2025-10-27 | Replace original file with proxy index |
| 410.6 | Run typecheck & tests, fix breakages | Not Started | 2025-10-27 | Iteratively fix imports and tests |
