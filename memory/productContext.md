...
SpaceAutoBattler is a small deterministic 3D auto-battler project used to experiment with AI, physics-driven interactions, and rendering patterns. It is both a playground for design of configurable ship classes and an integration example for deterministic simulations in the browser using Web Workers and Rapier3D.
...
- Renderer runs on main thread (Three.js) and must be decoupled from physics worker thread.
