...
import { findBestFormation, getFormationCenter, assignFormationSlot, clearFormationSlot } from '../../../src/core/ai/formation';

describe('formation module', () => {
  it('returns escort formation when carrier nearby', () => {
    const carrier = { id: 10, team: 'red', class: 'carrier', health: 100, pos: { x: 10, y: 0, z: 0 } } as any;
    const ship = { id: 1, team: 'red', class: 'fighter', health: 100, pos: { x: 12, y: 0, z: 0 } } as any;
    const state: any = { ships: [carrier, ship], behaviorConfig: { globalSettings: { formationSearchRadius: 50, formationMinGroupSize: 3 }, formations: { escort: { type: 'escort', maxSize: 3, spacing: 10 } } } };
  ...
  it('returns line formation when many nearby friends', () => {
    const ship = { id: 1, team: 'blue', class: 'fighter', health: 100, pos: { x: 0, y: 0, z: 0 } } as any;
    const friends = [
      ship,
      { id: 2, team: 'blue', class: 'fighter', health: 100, pos: { x: 1, y: 0, z: 0 } },
      { id: 3, team: 'blue', class: 'fighter', health: 100, pos: { x: 2, y: 0, z: 0 } },
    ];
    const cfg: any = { globalSettings: { formationSearchRadius: 100, formationMinGroupSize: 2 }, formations: { line: { type: 'line', maxSize: 8, spacing: 10 } } };
  ...
  it('computes formation center and assigns unique slots', () => {
    ...
    const state: any = { ships: [s1, s2], behaviorConfig: { globalSettings: { formationSearchRadius: 100 } } };
