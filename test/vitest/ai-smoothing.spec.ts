...
function createShip(id: number, profileId = 'brawler'): ShipEntity {
  ...
  const ship = {
    ...
    ship: { team: 'blue', hull: 'fighter', hp: 100, maxHp: 100, shield: 0, maxShield: 0, cooldown: 0, fireRate: 1, damage: 6, projectileSpeed: 30, range: 260, speed: 40, velocity: new Vector3(), angularVelocity: new Vector3(), lateralAcceleration: 0, motion: {} as any },
    ai,
