...
import { addParticleExplosion, ParticleSystem, type ParticleExplosionOptions } from '../../src/renderer/particleSystem.js';
...
describe('Particle Explosion API', () => {
  ...
  describe('addParticleExplosion function', () => {
    ...
    test('should create particles when called with valid options', () => {
      ...
      expect(statsAfter.activeCount).toBeGreaterThanOrEqual(RendererConfig.particles.explosion.minCount);
    });
