...
*¹ Includes turret DPS estimates*  
*² Includes potential 6-fighter production (53.34 DPS)*
...
*This report is based on static analysis of game code and configuration. Live gameplay testing is recommended to validate theoretical balance predictions and refine recommendations.*