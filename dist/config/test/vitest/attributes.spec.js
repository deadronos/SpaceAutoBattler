...
describe("Attributes", () => {
    ...
    it("should fail if required fields are missing", () => {
        ...
        const shipMissingDamage = { accel: 10, radius: 20, cannons: [{}] };
        expect(shipMissingDamage.cannons[0].damage).toBeUndefined();
        // Simulate missing accel
        const shipMissingAccel = { radius: 20, cannons: [{ damage: 5 }] };
        expect(shipMissingAccel.accel).toBeUndefined();
        // Simulate missing radius
        const shipMissingRadius = { accel: 10, cannons: [{ damage: 5 }] };
        expect(shipMissingRadius.radius).toBeUndefined();
    });
    it("should use fallback logic for legacy and new damage fields", () => {
        ...
        const damageBoth = shipBoth.cannons[0].damage || shipBoth.damage || shipBoth.dmg || 0;
