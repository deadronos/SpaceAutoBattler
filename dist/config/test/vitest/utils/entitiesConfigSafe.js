...
export function getShipConfigSafe() {
    if (typeof entitiesConfig.getShipConfig === "function")
        return entitiesConfig.getShipConfig();
    if (entitiesConfig.default && typeof entitiesConfig.default.getShipConfig === "function")
        return entitiesConfig.default.getShipConfig();
    if (typeof entitiesConfig.default === "object" && entitiesConfig.default)
        return entitiesConfig.default;
    if (entitiesConfig.ShipConfig && typeof entitiesConfig.ShipConfig === "object")
        return entitiesConfig.ShipConfig;
...
export function getSizeDefaultsSafe(size) {
    if (typeof entitiesConfig.getSizeDefaults === "function")
        return entitiesConfig.getSizeDefaults(size);
    if (entitiesConfig.default && typeof entitiesConfig.default.getSizeDefaults === "function")
        return entitiesConfig.default.getSizeDefaults(size);
    return {};
}
