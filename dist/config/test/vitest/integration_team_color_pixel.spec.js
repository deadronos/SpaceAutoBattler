...
function averageColorOfCanvasRegion(canvas, x, y, w, h) {
...
describe('integration: team-color pixel compare', () => {
    it('renders red and blue ships with distinguishable hull color averages', async () => {
        ...
        const teamRedColor = hexToRgb(TeamsConfig.teams.red.color || '#ff0000');
        const teamBlueColor = hexToRgb(TeamsConfig.teams.blue.color || '#0000ff');
