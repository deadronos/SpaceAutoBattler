...
describe('turret firing origin', () => {
    it('spawns bullet at tuple-style turret mountpoint (rotated + scaled by radius)', () => {
        ...
        const attacker = { id: 1, x: 50, y: 50, angle: 0, radius: 10, type: 'unknown-type', hp: 10, maxHp: 10, team: 'red', turrets: [[1, 0]] };
        // Defender sits to the right so AI will engage and fire from turret
        const defender = { id: 2, x: 80, y: 50, angle: 0, radius: 12, hp: 10, maxHp: 10, team: 'blue' };
