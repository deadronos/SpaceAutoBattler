...
describe("ShipTypes", () => {
    it("should have all expected ship types", () => {
        const cfg = (() => {
            ...
            return { fighter: { maxHp: 10, cannons: [{ damage: 3 }] }, corvette: { maxHp: 20, cannons: [{ damage: 4 }] }, frigate: { maxHp: 30, cannons: [{ damage: 5 }] }, destroyer: { maxHp: 40, cannons: [{ damage: 6 }], turrets: [{ position: [1.2, 0.8], kind: 'basic' }] }, carrier: { maxHp: 50, cannons: [{ damage: 2 }] } };
        })();
