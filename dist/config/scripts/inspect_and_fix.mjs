...
async function run() {
    ...
    const result = await page.evaluate(() => {
        try {
            ...
            try {
                r._tintedHullCache.delete && r._tintedHullCache.delete(key);
            }
            catch (e) { }
            ...
            try {
                ...
                return { error: 'draw_err:' + String(e) };
            }
            // store into cache via public Map-like API
            try {
                r._tintedHullCache.set(key, c);
            }
            catch (e) {
                try {
                    r._setTintedCanvas && r._setTintedCanvas(key, c);
                }
                catch (e2) {
                    return { error: 'set_err:' + String(e2) };
                }
            }
            // return dataURL
            try {
                ...
                return { error: 'toDataUrl:' + String(e) };
            }
        }
        catch (e) {
            return { error: String(e) };
