...
export class SVGRasterizer {
     ...
     */
    applySvgTeamColorTinting(svgText, teamColor) {
        return svgText
...
let globalRasterizer = null;
/**
 * Get the global SVG rasterizer instance
 */
export function getSVGRasterizer() {
    if (!globalRasterizer) {
 ...
 */
export async function rasterizeSvgToBitmap(svgText, width, height, options = {}) {
