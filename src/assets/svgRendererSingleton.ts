...
export function getSvgRendererSync(): any | undefined {
  try {
...
export async function getSvgRenderer(): Promise<any | undefined> {
  ...
  try {
    ...
    const inst = (m && (m.default || m)) as any;
    ...
    try {
      if (typeof globalThis !== "undefined") return (globalThis as any).__SpaceAutoBattler_svgRenderer;
    } catch (ee) {}
  }
  return undefined;
}
