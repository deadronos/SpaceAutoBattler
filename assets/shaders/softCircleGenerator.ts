 ...
 */
export function generateSoftCircleCanvas(
  options: Partial<SoftCircleOptions> = {},
): HTMLCanvasElement {
 ...
 */
export async function generateSoftCirclePNG(
  options: Partial<SoftCircleOptions> = {},
): Promise<Blob> {
 ...
 */
export function generateSoftCircleTexture(
  renderer: any,
  options: Partial<SoftCircleOptions> = {},
): any {
  const canvas = generateSoftCircleCanvas(options);
